...
const SlateGettingStarted = ({ projectName, modelName }: { projectName: string, modelName: string }) => {
    ...
    return (
        <div>
            <p className="mt-6 text-blue-500">Because you are just getting started, we highly recommend switching over to Blankly</p>
            <div>
                <p className="mt-6">1. Make sure you that you install <span className="inconsolata">blankly</span> first, then let&apos;s login...</p>
                ...
                <p className="mt-6 w-4/5">3. We&apos;ve given you a sample algorithm already in <span className="inconsolata">bot.py</span>, let&apos;s go ahead and run a backtest</p>
                <div className="flex mt-5">
                    <div className="bg-gray-100 w-full rounded-md">
                        <p className="inconsolata m-3 ml-6 text-md text-gray-700">
                            $&nbsp;&nbsp;python&nbsp;bot.py
                ...
                <p className="mt-6 w-4/5">Now since we&apos;ve logged in and set up our directory and connection with the platform, your first backtest should now be in the platform</p>
...
export default SlateGettingStarted;
