        ...
        <div className="h-fit w-full relative bg-white rounded-lg border border-gray-200 mb-8">
          <div className="p-8 mb-16">
            ...
            <p className="my-2 text-gray-400">
              ...
              or if you&apos;ve explicitly defined a <a href="blankly-platform-open-source-main/components/teams/general-details#" className="text-red-400">deployments.json</a>
            </p>
            <div className="mt-4">
              <div className="mt-1">
                <input
          ...
          <div
            ...
            <p className="text-gray-400">Learn more about <a href="blankly-platform-open-source-main/components/teams/general-details#" className="text-blue-600">Root Directory</a></p>
