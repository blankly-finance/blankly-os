...
const BlanklyGettingStarted = ({projectName, modelName}: {projectName: string, modelName: string}) => {
    ...
    return (
        <div>
            <p className="mt-6">1. Make sure you install <span className="inconsolata">blankly</span> first, then let&apos;s login...</p>
...
export default BlanklyGettingStarted;
