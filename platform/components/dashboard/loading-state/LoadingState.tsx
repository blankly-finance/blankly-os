...
function LoadingState(props: { loading: boolean }) {
  ...
  return (
    <>
      {
        loading ?
          <div className="relative max-w-6xl p-5 sm:p-0 mx-auto -mt-20 grid gap-8 sm:grid-cols-2 grid-cols-1 md:grid-cols-3">
