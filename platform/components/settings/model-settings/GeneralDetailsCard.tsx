      ...
      <div className="flex flex-col w-full h-full items-center justify-start mt-8">
        <div className="h-fit w-full relative bg-white rounded-lg border border-gray-200 mb-8">
          ...
          <div
            ...
            <p className="text-gray-400 text-sm">Learn more about <a href="blankly-platform-open-source-main/components/settings/model-settings#" className="text-blue-500">Model Name
              and ID</a></p>
            <button type="submit"
