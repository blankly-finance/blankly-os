...
const CompareMetricCard = (props: { metric: any, backtestIds: Array<string>, backtests: any, colors: any }) => {
          ...
          return (
            <div style={{color: props.colors[index]}} key={index}
              ...
              <div
                ...
                {props.backtests[index]?.description ? props.backtests[index].description.slice(0, 15) : props.backtestIds[index].slice(0, 15)}{props.backtestIds[index]?.length > 10 ? "..." : ""}
              </div>
...
export default CompareMetricCard;
