...
import {deleteBacktest} from '@/services/backtest-store'
import {StopIcon} from '@heroicons/react/solid'

export default function DeleteBacktest({ projectId, modelId, backtestId, open, close }: any) {

  const cancelButtonRef = useRef(null)

  const removeBacktest = useCallback(() => {
    close()
    deleteBacktest(projectId, modelId, backtestId)
  }, [backtestId, close, modelId, projectId])
              ...
              <div>
                ...
                <div className="mt-3 text-center sm:mt-5">
                  <Dialog.Title as="h3" className="text-lg leading-6 font-medium text-gray-900">
                    Are you sure you want to delete backtest {backtestId}?
                  </Dialog.Title>
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      This action is not reversible, and the backtest data will be removed.
                    </p>
                  </div>
                </div>
              </div>
